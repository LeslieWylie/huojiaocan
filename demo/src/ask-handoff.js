...
export function localBackupFailureMatters({ localSaveFailed, agentRuntimeEnabled, accountSaveFailed, draftId } = {}) {
  return Boolean(localSaveFailed && (!agentRuntimeEnabled || accountSaveFailed || !draftId));
}
