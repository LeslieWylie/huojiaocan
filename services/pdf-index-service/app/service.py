...
class IndexService:
    ...
    def ingest_pdf(self, request):
        """Read a PDF page-by-page and feed images only to the OCR provider.

        This is intentionally an internal endpoint. The original PDF bytes are
        never replaced by OCR output and physical page numbers come directly
        from PyMuPDF's one-based page order.
        """
